...
if(isset($_POST['regSubmit'])){
    ...
    $next_kin_email = $_POST['next_kin_email'];
            ...
            <div class="form-wizard ">
                <form action="" method="post" role="form" enctype="multipart/form-data">
                    ...
                    <fieldset class="wizard-fieldset">
                        ...
                        <h5 class="my-4">Next of Kin Details</h5>
                        <div class="form-group">
                            <input type="text" class="form-control wizard-required" id="next_kin_name" name="next_kin_name">
                            <label for="email" class="wizard-form-text-label">Next of Kin Full Name*</label>
                            <div class="wizard-form-error"></div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="number" class="form-control wizard-required" id="next_kin_phone"
                                           name="next_kin_phone">
                                    <label for="phoneNumber" class="wizard-form-text-label">Next of Kin Phone Number*</label>
                                    <div class="wizard-form-error"></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control wizard-required" id="next_kin_name" name="next_kin_email">
                                    <label for="email" class="wizard-form-text-label">Next of Kin Email*</label>
                                    <div class="wizard-form-error"></div>
                                </div>
                            </div>
                        </div>
